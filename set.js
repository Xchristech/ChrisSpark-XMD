...
module.exports = { session: process.env.SESSION_ID || 'chris',
    ...
    URL: process.env.URL || "https://files.catbox.moe/gz4clo.png",  
    URL2: process.env.URL2 || "https://files.catbox.moe/mclibf.png",
