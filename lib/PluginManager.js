...
class PluginManager {
  ...
  async loadPlugins() {
    try {
        console.log("[❄CHRISSPARK-XMD❄ ] Loading plugins...");
        ...
        console.log("[❄CHRISSPARK-XMD❄] Plugins loaded successfully.");
    } catch (error) {
        console.error("[❄CHRISSPARK-XMD❄] Error loading plugins:", error);
    }
}
