...
//const { getGroupe } = require("../chrisdatabase/groupe")
...
// COMMAND TO TAGALL
ezra({ nomCom: "tagall", categorie: 'Chris-Group', reaction: "📯" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "link", categorie: 'Chris-Group', reaction: "🚜" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "remove", categorie: 'Chris-Group', reaction: "😱" }, async (dest, zk, commandeOptions) => {
          ...
          if (membre) {
            if (admin == false) {
              ...
              var sticker = new Sticker(gifLink, {
                pack: 'CHRISSPARK-XMD', // The pack name
...
// COMMAND TO DELETE 
ezra({ nomCom: "del", categorie: 'Chris-Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "info", categorie: 'Chris-Group' }, async (dest, zk, commandeOptions) => {
 ...
 ezra({ nomCom: "antilink", categorie: 'Chris-Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
...
const cron = require(`../chrisdatabase/cron`) ;
