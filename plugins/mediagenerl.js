...
ezra({nomCom : "igdl" , categorie : "Chris-Download"},async (dest , zk , commandeOptions)=>{
...
async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       zk.sendMessage(dest,{image : { url : result.thumbnail}, caption : caption},{quoted : ms}) ;
       zk.sendMessage(dest, { video: { url: result.sd  }, caption: 'facebook video downloader powered by *CHRISSPARK XMD*' }, { quoted: ms });
