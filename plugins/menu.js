...
ezra({ 
    nomCom: "menu", 
    categorie: "Chris-Menu", 
    reaction: "⚡", 
    nomFichier: __filename 
}, async (dest, zk, commandeOptions) => {
    const { repondre, prefixe, nomAuteurMessage } = commandeOptions;
    const { cm } = require("../christy/gaaju");
    let coms = {};
    let mode = "public";
    ...
    const img = 'https://files.catbox.moe/038adg.png';
    const imgs = 'https://files.catbox.moe/mclibf.png';

    const infoMsg = `
╭───────────⊷
*┋* *ʙᴏᴛ ɴᴀᴍᴇ :  CHRISSPARK XMD*
*┋* *ᴘʀᴇғɪx :* [ ${s.PREFIXE} ]
*┋* *ᴍᴏᴅᴇ :* ${mode}
*┋* *ᴅᴀᴛᴇ  :* ${date}
        ...
        await zk.sendMessage(dest, { 
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    body: "🔑🗝️ Command List",
                    thumbnailUrl: "https://files.catbox.moe/gz4clo.png",
