...
ezra({ nomCom: "quran-list", categorie: "Chris-Menu" }, async (dest, zk, commandeOptions) => {
    ...
    moment.tz.setDefault("Africa/Lagos Es Salam");
 ...
 `;
    ...
    try {
        await zk.sendMessage(dest, { 
            image: { url: "https://files.catbox.moe/mclibf.png" },
