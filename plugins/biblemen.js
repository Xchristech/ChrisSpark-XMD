...
const { format } = require(__dirname + "/../christy/mesfonctions");
const os = require("os");
...
ezra({ nomCom: "bible-list", categorie: "Chris-Menu" }, async (dest, zk, commandeOptions) => {
    let { ms, repondre ,prefixe,nomAuteurMessage,mybotpic} = commandeOptions;
    let { cm } = require(__dirname + "/../christy//gaaju");
    var coms = {};
    var mode = "public";
